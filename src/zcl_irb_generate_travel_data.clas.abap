CLASS zcl_irb_generate_travel_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_irb_generate_travel_data IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA itab TYPE TABLE OF zirb_t_travel.
...
*   delete existing entries in the database table
    DELETE FROM zirb_t_travel.

*   insert the new table entries
    INSERT zirb_t_travel FROM TABLE @itab.
